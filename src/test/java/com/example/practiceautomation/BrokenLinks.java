...
public class BrokenLinks {
 ...
 // @Test
  public void testBrokenLinks1() throws Exception {
    ...
    element = driver.findElement(By.xpath("//article[@id='post-1267']/div/figure/table/thead/tr/th[1]"));
  ...
  public void testBrokenLinks() throws Exception {
	...
	//Point de Verification: Résultat attendu
    assertEquals("Broken Links", brokenlinksPage.getHeadLine().getText());
    ...
    assertEquals("404" , brokenlinksPage.getQuatreQuatrePageText().getText());
    
    assertEquals("missing-page.html" , brokenlinksPage.getMissingPageText().getText());
